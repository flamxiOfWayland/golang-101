...
const file_greeter_greeter_proto_rawDesc = "" +
	"\n" +
	"\x15greeter/greeter.proto\"\"\n" +
	"\fHelloRequest\x12\x12\n" +
	"\x04name\x18\x01 \x02(\tR\x04name\"&\n" +
	"\n" +
	"HelloReply\x12\x18\n" +
	"\amessage\x18\x01 \x02(\tR\amessage2b\n" +
	"\aGreeter\x12(\n" +
	"\bSayHello\x12\r.HelloRequest\x1a\v.HelloReply\"\x00\x12-\n" +
	"\rSayHelloAgain\x12\r.HelloRequest\x1a\v.HelloReply\"\x00B/Z-github.com/flamxiOfWayland/golang-101/greeter"
